...
import { selectCategoryFilter, selectItemAmount, setCategoryFilter, setItemAmount } from '../../store/inventory';
...
const InventoryControl: React.FC = () => {
  ...
  const handleCategoryChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    const newCategory = event.target.value === 'all' ? null : event.target.value;
      ...
      <div className="inventory-control">
        <div className="inventory-control-wrapper">
          ...
          <button className="useful-controls-button" onClick={() => setInfoVisible(true)}>
            <svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 524 524" fill="#cdd6f4">
          ...
          >
            ...
            <option value="storage">Storage Items</option>
